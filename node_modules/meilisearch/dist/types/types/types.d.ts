...
export declare type SearchParams = Pagination & Highlight & Crop & {
    filter?: Filter;
    sort?: string[];
...
export declare type SearchRequest = SearchParams & Query;
...
export declare type FacetsDistribution = Record<Facet, CategoriesDistribution>;
export declare type _matchesInfo<T> = Partial<Record<keyof T, Array<{
    start: number;
    length: number;
}>>>;
...
export declare type MeiliSearchErrorBody = {
    code: string;
    link: string;
    message: string;
    type: string;
